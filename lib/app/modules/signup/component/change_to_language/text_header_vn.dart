...
class TextHeaderSingupVN extends StatelessWidget {
  String title;

  var screenSaverController = Get.put(ScreenSaverController());

  TextHeaderSingupVN(this.title,{Key? key}) : super(key: key);
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(
              top: SizePhone(context).height/40,
              ...
              children: [
                ...
                Center(
                  child: Text(title,style: TextStyle(
                      fontSize: SizePhone(context).width/13,
                      color: kColorWhite,
